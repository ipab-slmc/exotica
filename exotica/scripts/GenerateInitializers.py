...
public:
    ...
    """ +ClassName+"() : PropertyContainer(\""+Namespace+"::"+ClassName+"\")"+DefaultConstructorList(Data)+"""
    {
        RegisterParams();
    }

    """ +ClassName+"("+ConstructorArgumentList(Data)+") : PropertyContainer(\""+Namespace+"::"+ClassName+"\")"+ConstructorList(Data)+"""
    {
        RegisterParams();
    }
...
if __name__ == "__main__":
    if len(sys.argv)>5:
        for i in range(4,len(sys.argv)):
            Generate(sys.argv[2]+"/"+sys.argv[i],sys.argv[3]+"/"+sys.argv[i][0:-3]+".h",sys.argv[1],sys.argv[i][0:-3])
    else:
