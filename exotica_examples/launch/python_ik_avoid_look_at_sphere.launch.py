...
def generate_launch_description():
    ...
    actions.append(Node(
        ...
        executable='example_ik_avoid_look_at_sphere',
        name='example_ik_avoid_look_at_sphere_node',
        output='screen',
    ))
    ...
    actions.append(Node(
        ...
        executable='rviz2',
        name='rviz2',
        arguments=['-d', os.path.join(pkg, 'resources/rviz_avoid_look_at_sphere.rviz')]))
