...
class TargetMarker:
    def __init__(self, node,
        ...
        # position_exo: pyexotica KDLFrame, updated on interactive marker feedback
        self.position_exo = exo.KDLFrame(pose)
        # ROS2: InteractiveMarkerServer requires a node as the first argument
        self.server = InteractiveMarkerServer(node, server_name)
