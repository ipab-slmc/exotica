...
SceneInit=exotica.Initializer('Scene',struct('Name','MyScene','Solver',{{'Kinematica',struct('Joints','lwr_arm_0_joint,lwr_arm_1_joint,lwr_arm_2_joint,lwr_arm_3_joint,lwr_arm_4_joint,lwr_arm_5_joint,lwr_arm_6_joint','Root',{{'Limb',struct('Segment','base')}})}}));
