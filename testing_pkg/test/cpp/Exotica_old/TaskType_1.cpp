...
ExoticaTaskTest_1::ExoticaTaskTest_1(const exotica::OptimisationParameters_t & optimisation_params) : TaskDefinition(optimisation_params)
{
  name = "ExoticaTask_1";
...
bool ExoticaTaskTest_1::updateTask(Eigen::VectorXdRefConst configuration, int index)
{
  ...
  phi << configuration[0]*configuration[0] + 2*configuration[1] + configuration[2];
