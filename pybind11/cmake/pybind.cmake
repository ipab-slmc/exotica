...
message(WARN "Checking python executable: ${PYBIND_PYTHON_EXECUTABLE}")
set(TEMP_PYTHON_EXECUTABLE ${PYTHON_EXECUTABLE})
if(DEFINED PYBIND_PYTHON_EXECUTABLE)
    message(WARN "Changing executable")
    set(PYTHON_EXECUTABLE ${PYBIND_PYTHON_EXECUTABLE} CACHE INTERNAL "")
endif()

message(WARN "Using python executable: ${PYTHON_EXECUTABLE}")
...
message(WARN "Python: ${PYTHON_INCLUDE_DIRS}")
message(WARN "Python: ${PYTHON_LIBRARIES}")
message(WARN "Python: ${PYTHON_MODULE_PREFIX}")
message(WARN "Python: ${PYTHON_MODULE_EXTENSION}")
