...
private:
  ...
  void meanShiftThreadFn(int id, std::pair<unsigned int, unsigned int> &volumes, DRMClusterParam &param);
  void meanShiftClusterVolume(int thread_id, unsigned int index, DRMClusterParam &param);
