...
namespace exotica
{
   ...
   */
	...
	public:
		 ...
		 * @return SUCESS if solution has been found, corresponding error code if not.
		 */
		EReturn Solve(const std::vector<Eigen::VectorXd>& q_init, Eigen::MatrixXd & solution);
		 ...
		 */
		EReturn inverseSymPosDef(Eigen::Ref<Eigen::MatrixXd> Ainv_, const Eigen::Ref<const Eigen::MatrixXd> & A_);
	...
	private:
	   ...
	   */
	  void getProcess(Eigen::Ref<Eigen::MatrixXd> A_,Eigen::Ref<Eigen::VectorXd> a_,Eigen::Ref<Eigen::MatrixXd> B_);
