...
PositionSolverType_1::PositionSolverType_1(const exotica::OptimisationParameters_t & params) : 
  PositionSolver(params),
  name ("PositionSolverType_1"),
  params_ref_(optimisation_params_),
  vel_solv_ref_(vel_solver_)
{
  clearFlags();
}
