...
#define WARNING(x)				std::clog << "\033[1;32m[EXOTica]:\033[0m Warning in " << __FILE__ << " at line " << __LINE__ << " within function " << __PRETTY_FUNCTION__ << ": " << x << "\n";//!< With endline
...
#define HIGHLIGHT_NAMED(name, x)std::cout << "\033[1;32m[EXOTica]:\033[0m \033[33m[" << name <<"]\033[0m \033[36m" << x << "\033[0m\n";
namespace Eigen
{
