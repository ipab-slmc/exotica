...
public:
  ...
  bool loadSpace(const std::string &path, DRMSpace_ptr &space, const robot_model::RobotModelConstPtr &model);
private:
  class MultiThreadsSpaceOccupationLoader
  {
  public:
    MultiThreadsSpaceOccupationLoader(const std::string & path, DRMSpace_ptr &space);
